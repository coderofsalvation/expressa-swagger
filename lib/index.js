...
module.exports = function(opts){ 
  ...
  app.use( '/api/swagger', function(req, res, next){
    var collectionnames = Object.keys(expressa.db)
    for( collectioname in expressa.db ) generateEndpoints(collectionname)
  ...
  app.use("/api/client",function(req,res,next){
    var clientcode = fs.readFileSync( __dirname + '/../public/client.js' ).toString()
